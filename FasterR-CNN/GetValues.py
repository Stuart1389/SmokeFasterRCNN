...
def setTrainValues(val_to_get):
    ...
    train_values = {
        ...
        "model_name": "transform_csj_add_anc_large_a100", # name of saved model
        "plotJSON_fname": "transform_csj_add_anc_large_a100", # json filename
        "model_id": "56",
        "save_at_end" : False,
...
def setTestValues(val_to_get):
    ...
    test_values = {
        ...
        "model_name": "transform_csj_add_anc_a100", # name of model to test

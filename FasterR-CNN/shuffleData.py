...
main_dir = "N:/University subjects/Thesis/Python projects/SmokeFasterRCNN/Dataset/Large data/Main"
main_annot = os.path.join(main_dir, "annotations/xmls")
main_image = os.path.join(main_dir, "images")

# Train dir
train_dir = "N:/University subjects/Thesis/Python projects/SmokeFasterRCNN/Dataset/Large data/Train"
train_annot = os.path.join(train_dir, "annotations/xmls")
train_image = os.path.join(train_dir, "images")

# Test dir
test_dir = "N:/University subjects/Thesis/Python projects/SmokeFasterRCNN/Dataset/Large data/Test"

...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.stride = stride
        # Float functional, convert tensor to fp for arithmetic
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if(setTestValues("static_quant") or setTrainValues("quant_aware_training")):
            out = self.float_func_add.add(out, identity)
        else:
            out += identity
        out = self.relu(out)

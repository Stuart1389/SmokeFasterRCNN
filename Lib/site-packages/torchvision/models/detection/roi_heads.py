...
def fastrcnn_loss(class_logits, box_regression, labels, regression_targets):
    ...
    Returns:
        ...
        box_loss (Tensor)
    """
    #print("box_regression shape b4:", box_regression.shape)
    ...
    # get pos
    #box_reg = box_regression[sampled_pos_inds_subset]
    #regression_targets = regression_targets[sampled_pos_inds_subset]
    logits = {
        "logit_classification": class_logits,
        "logit_bbox_delta": box_regression[:, 1, :]
    }
    #print("f_loss logit_classification:", logits["logit_classification"].shape)
    #print("f_loss logit_bbox_delta:", logits["logit_bbox_delta"].shape)
    #print("f_loss regression_targets:", regression_targets.shape)
    #print("reg box roi pos: ",box_regression[sampled_pos_inds_subset].shape)
    #print("reg tarh roi pos: ", regression_targets[sampled_pos_inds_subset].shape)
    return classification_loss, box_loss, logits, regression_targets
...
class RoIHeads(nn.Module):
    ...
    def postprocess_detections(
        ...
        logits = {
            "logit_classification": class_logits,
            "logit_bbox_delta": box_regression[:, 4:] # get foreground class
        }
        print("logit_classification B roi: ", logits["logit_classification"].shape)
        print("box_regression B roi: ", logits["logit_bbox_delta"].shape)
        """
    ...
    def forward(
        ...
        if labels is not None and regression_targets is not None:
            loss_classifier, loss_box_reg, logits, regression_targets = fastrcnn_loss(class_logits, box_regression, labels, regression_targets)
            losses = {"loss_classifier": loss_classifier, "loss_box_reg": loss_box_reg}
        #print("class logits: roi", class_logits.shape)
        #print("box_regression: roi", box_regression.shape)
        ...
        if targets is None:
            regression_targets = None
            logits = None
        return result, losses, logits, regression_targets

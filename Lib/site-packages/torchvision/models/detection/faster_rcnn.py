    ...
    **kwargs: Any,
    ...
    if weights is not None:
        ...
        model_weights["rpn.head.cls_logits.weight"] = expand_weights(model_weights["rpn.head.cls_logits.weight"],
                                                                     (15, 256, 1, 1))
        model_weights["rpn.head.cls_logits.bias"] = expand_bias(model_weights["rpn.head.cls_logits.bias"], (15,))
        model_weights["rpn.head.bbox_pred.weight"] = expand_weights(model_weights["rpn.head.bbox_pred.weight"],
                                                                    (60, 256, 1, 1))
        model_weights["rpn.head.bbox_pred.bias"] = expand_bias(model_weights["rpn.head.bbox_pred.bias"], (60,))
        """
...
def stus_resnet_fpnv2_builder(
    ...
    **kwargs: Any,
    ...
    #model.roi_heads.load_state_dict(roi_head_weights)

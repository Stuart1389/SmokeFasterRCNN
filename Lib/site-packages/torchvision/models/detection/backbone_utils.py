...
from SmokeUtils import SmokeIntermediateLayerGetter
...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(
        ...
        if(setTrainValues("quant_aware_training" or setTestValues("static_quant") or setTestValues("load_QAT_model"))):
            self.body = SmokeIntermediateLayerGetter(backbone, return_layers=return_layers)
        else:
            #self.body = IntermediateLayerGetter(backbone, return_layers=return_layers)
            self.body = SmokeIntermediateLayerGetter(backbone, return_layers=return_layers)
        #print("101return", return_layers)
